/* 						Country of JAPAN VERSION OF PARAMETERS
     by SCRIER.org 
...
#ifndef JPARAMETERS_H
#define JPARAMETERS_H
...
// For the Severes, this is the last day that they're still sick,
// until they check into the hospital the next day.  If any slots open.
// For the Criticals, this is also the last day that they're still sick,
...
#define   DAYS_SEVERE_UNAWARE_INFECTIOUS  5
...
double Actual_to_official_factor_10 = 4.0;  // Number of actual cases/official.
...
double N_USpop_total_count = 126500000;  //number of adults over 14
